...
open class WKCFansySlider: UIView {
    ...
    /// thumb颜色
    public var thumbColor: UIColor = .green {
        willSet {
    ...
    public var progressLabelSize: CGSize = .zero {
        willSet {
            ...
            progressLabel.center.y = maxY - newValue.height / 2.0
    ...
    public var progressLabelBottomMagin: CGFloat = 0 {
        willSet {
            progressLabel.center.y = thumbImageView.frame.origin.y - progressLabelBottomMagin - progressLabel.frame.height / 2.0
...
extension WKCFansySlider {
    ...
    private func setupSunviewsFrame(alignment: Alignment,
        ...
        thumbImageView.layer.cornerRadius = thumbImageView.layer.bounds.height * 0.5
    ...
    private func getSliderFrame(alignment: Alignment) -> CGRect {
        ...
        let sliderSize: CGSize = self.sliderSize.equalTo(.zero) ? CGSize(width: width - 30 * 2, height: 3) : self.sliderSize
    ...
    private func setThumbFrame(progress: CGFloat) {
        ...
        progressImageView.frame.size.width = progressImageWidth
        thumbImageView.center.x = thumbCenterX
        
        if shouldShowProgressLabel {
            progressLabel.isHidden = false
            progressLabel.layer.opacity = 1.0
            progressLabel.center.x = thumbCenterX
