...
private extension Selector {
    static let buttonTapped = #selector(ZXDatePickerView.buttonTapped)
    static let deviceOrientationDidChange = #selector(ZXDatePickerView.deviceOrientationDidChange)
}

open class ZXDatePickerView: UIView {
