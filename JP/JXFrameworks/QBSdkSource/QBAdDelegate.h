...
#pragma mark  全屏视频广告回调
@protocol QBFullScreenVideoAdDelegate <NSObject>

@optional

///广告加载失败，msg加载失败说明（如果重新请求广告，注意：只重新请求一次）
- (void) qb_onFullScreenAdFail:(NSString*)error;

///视频被点击
- (void) qb_onFullScreenAdClicked;

///视频被关闭
- (void) qb_onFullScreenAdClose;

///视频广告曝光
- (void) qb_onFullScreenAdExposure;

///视频广告加载完成，此时播放视频不卡顿
- (void) qb_onFullScreenVideoCached;

///视频播放完成
- (void) qb_onFullScreenVideoComplete;
